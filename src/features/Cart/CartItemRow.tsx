...
import type { CartItemWithFood } from "./useCart";
  ...
  return (
    <div className="flex items-center gap-4 bg-white border border-[#EEF0F2] rounded-3xl p-4">
      ...
      <div className="flex-1 min-w-0">
        ...
        <Link
          href={`/restaurants/${item.food.restaurant.slug}`}
          className="text-[12px] text-muted-foreground hover:text-secondary transition-colors block"
        >
